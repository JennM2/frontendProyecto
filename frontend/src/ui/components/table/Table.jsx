...
const Table = ({ columns, data, icon, icon2, icon3, columnIcon, textLink, columnAction, className, className2, classNameIcon, onClick, onDelete, onAdd, start, end, onEdit, tableRef, classLink }) => {
