...
const Payments = () => {
    ...
    const columns = ['N°', 'AR', 'AM', 'Nombre', 'Matrícula', 'Carrera', 'Monto', 'Fecha'];
    const [data, setData] = useState([
        ['1', 'AR', 'AM', 'Juan Perez', '51258', 'Carrera', 'Monto', '20-05-2020'],
        ['2', 'AR', 'AM', 'Carmer García', '12258', 'Carrera', 'Monto', '20-05-2020'],
        ['3', 'AR', 'AM', 'Maria Garzón', '12586', 'Carrera', 'Monto', '20-05-2022'],
    ]);
